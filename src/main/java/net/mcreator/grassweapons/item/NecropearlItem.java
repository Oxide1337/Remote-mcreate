...
public class NecropearlItem extends GrassWeaponsModElements.ModElement {
	@ObjectHolder("grass_weapons:necropearl")
	public static final Item block = null;
	public NecropearlItem(GrassWeaponsModElements instance) {
		super(instance, 47);
	}
