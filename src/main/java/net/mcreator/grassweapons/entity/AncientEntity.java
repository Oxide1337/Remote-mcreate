...
package net.mcreator.grassweapons.entity;
...
import net.mcreator.grassweapons.entity.renderer.AncientRenderer;
import net.mcreator.grassweapons.GrassWeaponsModElements;

@GrassWeaponsModElements.ModElement.Tag
public class AncientEntity extends GrassWeaponsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 1f)).build("ancient").setRegistryName("ancient");
	public AncientEntity(GrassWeaponsModElements instance) {
		super(instance, 51);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AncientRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -5920733, -3815995, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("ancient_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(SharpoflightningItem.block, (int) (1)));
		}
